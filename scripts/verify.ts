...
const cases: Case[] = [
  ...
  { id: 'unique-paths-ii', input: { grid: '0,0,0; 0,1,0; 0,0,0' }, expect: 2, got: (v) => v.result },
  { id: 'unique-paths-ii', input: { grid: '0,1; 0,0' }, expect: 1, got: (v) => v.result },
  { id: 'unique-paths-ii', input: { grid: '1' }, expect: 0, got: (v) => v.result },
  { id: 'unique-paths-ii', input: { grid: '0,0; 1,1; 0,0' }, expect: 0, got: (v) => v.result },
  { id: 'minimum-path-sum', input: { grid: '1,3,1; 1,5,1; 4,2,1' }, expect: 7, got: (v) => v.result },
  { id: 'minimum-path-sum', input: { grid: '1,2,3; 4,5,6' }, expect: 12, got: (v) => v.result },
  { id: 'minimum-path-sum', input: { grid: '5' }, expect: 5, got: (v) => v.result },
  { id: 'longest-increasing-path-in-a-matrix', input: { matrix: '9,9,4; 6,6,8; 2,1,1' }, expect: 4, got: (v) => v.result },
  { id: 'longest-increasing-path-in-a-matrix', input: { matrix: '3,4,5; 3,2,6; 2,2,1' }, expect: 4, got: (v) => v.result },
  { id: 'longest-increasing-path-in-a-matrix', input: { matrix: '1' }, expect: 1, got: (v) => v.result },
  { id: 'longest-increasing-path-in-a-matrix', input: { matrix: '7,7; 7,7' }, expect: 1, got: (v) => v.result },
  { id: 'edit-distance', input: { a: 'horse', b: 'ros' }, expect: 3, got: (v) => v.result },
  { id: 'edit-distance', input: { a: 'intent', b: 'exec' }, expect: 5, got: (v) => v.result },
  { id: 'edit-distance', input: { a: 'abc', b: 'abc' }, expect: 0, got: (v) => v.result },
  { id: 'edit-distance', input: { a: '', b: 'abc' }, expect: 3, got: (v) => v.result },
  { id: 'edit-distance', input: { a: 'abc', b: '' }, expect: 3, got: (v) => v.result },
  { id: 'distinct-subsequences', input: { s: 'rabbbit', t: 'rabbit' }, expect: 3, got: (v) => v.result },
  { id: 'distinct-subsequences', input: { s: 'babgbag', t: 'bag' }, expect: 5, got: (v) => v.result },
  { id: 'distinct-subsequences', input: { s: 'abc', t: 'abcd' }, expect: 0, got: (v) => v.result },
  { id: 'distinct-subsequences', input: { s: 'aaa', t: 'a' }, expect: 3, got: (v) => v.result },
  { id: 'interleaving-string', input: { s1: 'aabcc', s2: 'dbbca', s3: 'aadbbcbcac' }, expect: true, got: (v) => v.result },
  { id: 'interleaving-string', input: { s1: 'aabcc', s2: 'dbbca', s3: 'aadbbbaccc' }, expect: false, got: (v) => v.result },
  { id: 'interleaving-string', input: { s1: '', s2: '', s3: '' }, expect: true, got: (v) => v.result },
  { id: 'interleaving-string', input: { s1: 'a', s2: 'b', s3: 'ab' }, expect: true, got: (v) => v.result },
  { id: 'interleaving-string', input: { s1: 'a', s2: '', s3: 'ab' }, expect: false, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: 'aab', p: 'c*a*b' }, expect: true, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: 'aa', p: 'a' }, expect: false, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: 'aa', p: 'a*' }, expect: true, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: 'ab', p: '.*' }, expect: true, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: 'abc', p: 'a*c' }, expect: false, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: 'aaa', p: 'ab*a*c*a' }, expect: true, got: (v) => v.result },
  { id: 'regular-expression-matching', input: { s: '', p: 'a*' }, expect: true, got: (v) => v.result },
  { id: 'last-stone-weight-ii', input: { stones: [1, 2, 3, 9] }, expect: 3, got: (v) => v.result },
  { id: 'last-stone-weight-ii', input: { stones: [2, 7, 4, 1] }, expect: 0, got: (v) => v.result },
  { id: 'last-stone-weight-ii', input: { stones: [8] }, expect: 8, got: (v) => v.result },
  { id: 'last-stone-weight-ii', input: { stones: [3, 3] }, expect: 0, got: (v) => v.result },
  { id: 'coin-change-ii', input: { amount: 5, coins: [1, 2, 5] }, expect: 4, got: (v) => v.result },
  { id: 'coin-change-ii', input: { amount: 3, coins: [2] }, expect: 0, got: (v) => v.result },
  { id: 'coin-change-ii', input: { amount: 10, coins: [10] }, expect: 1, got: (v) => v.result },
  { id: 'coin-change-ii', input: { amount: 0, coins: [1, 2] }, expect: 1, got: (v) => v.result },
  { id: 'target-sum', input: { nums: [1, 1, 1, 1, 1], target: 3 }, expect: 5, got: (v) => v.result },
  { id: 'target-sum', input: { nums: [1], target: 1 }, expect: 1, got: (v) => v.result },
  { id: 'target-sum', input: { nums: [1], target: 2 }, expect: 0, got: (v) => v.result },
  { id: 'target-sum', input: { nums: [1, 2, 3], target: 0 }, expect: 2, got: (v) => v.result },
  { id: 'target-sum', input: { nums: [0, 1], target: 1 }, expect: 2, got: (v) => v.result },
  { id: 'best-time-to-buy-and-sell-stock-with-cooldown', input: { prices: [1, 2, 3, 0, 2] }, expect: 3, got: (v) => v.result },
  { id: 'best-time-to-buy-and-sell-stock-with-cooldown', input: { prices: [1] }, expect: 0, got: (v) => v.result },
  { id: 'best-time-to-buy-and-sell-stock-with-cooldown', input: { prices: [5, 4, 3, 2, 1] }, expect: 0, got: (v) => v.result },
  { id: 'best-time-to-buy-and-sell-stock-with-cooldown', input: { prices: [1, 4, 2, 7] }, expect: 6, got: (v) => v.result },
  // Two trades beat one here only because the cooldown day fits between them.
  { id: 'best-time-to-buy-and-sell-stock-with-cooldown', input: { prices: [1, 5, 1, 1, 5] }, expect: 8, got: (v) => v.result },
  { id: 'stone-game', input: { piles: [5, 3, 4, 5] }, expect: true, got: (v) => v.result },
  { id: 'stone-game', input: { piles: [3, 7, 2, 3] }, expect: true, got: (v) => v.result },
  { id: 'stone-game', input: { piles: [7] }, expect: true, got: (v) => v.result },
  { id: 'stone-game-ii', input: { piles: [2, 7, 9, 4, 4] }, expect: 10, got: (v) => v.result },
  { id: 'stone-game-ii', input: { piles: [1, 2, 3, 4, 5, 100] }, expect: 104, got: (v) => v.result },
  { id: 'stone-game-ii', input: { piles: [6] }, expect: 6, got: (v) => v.result },
  { id: 'burst-balloons', input: { nums: [3, 1, 5, 8] }, expect: 167, got: (v) => v.result },
  { id: 'burst-balloons', input: { nums: [1, 5] }, expect: 10, got: (v) => v.result },
  { id: 'burst-balloons', input: { nums: [7] }, expect: 7, got: (v) => v.result },
  // Backtracking
  { id: 'subsets', input: { nums: [1, 2, 3] }, expect: 8, got: (v) => v.result },
  { id: 'subsets', input: { nums: [1, 2] }, expect: '[1,2] [1] [2] []', got: (v) => (v.res as string[]).join(' ') },
  { id: 'subsets', input: { nums: [7] }, expect: 2, got: (v) => v.result },
  { id: 'subsets-ii', input: { nums: [1, 2, 2] }, expect: 6, got: (v) => v.result },
  { id: 'subsets-ii', input: { nums: [1, 2, 2] }, expect: '[1,2,2] [1,2] [1] [2,2] [2] []', got: (v) => (v.res as string[]).join(' ') },
  { id: 'subsets-ii', input: { nums: [0] }, expect: 2, got: (v) => v.result },
  { id: 'subsets-ii', input: { nums: [4, 4, 4] }, expect: 4, got: (v) => v.result },
  { id: 'combinations', input: { n: 4, k: 2 }, expect: 6, got: (v) => v.result },
  { id: 'combinations', input: { n: 4, k: 2 }, expect: '[1,2] [1,3] [1,4] [2,3] [2,4] [3,4]', got: (v) => (v.res as string[]).join(' ') },
  { id: 'combinations', input: { n: 5, k: 1 }, expect: 5, got: (v) => v.result },
  { id: 'combinations', input: { n: 3, k: 3 }, expect: 1, got: (v) => v.result },
  { id: 'combination-sum-ii', input: { candidates: [10, 1, 2, 7, 6, 1, 5], target: 8 }, expect: 4, got: (v) => v.result },
  { id: 'combination-sum-ii', input: { candidates: [2, 5, 2, 1, 2], target: 5 }, expect: 2, got: (v) => v.result },
  { id: 'combination-sum-ii', input: { candidates: [3, 3], target: 9 }, expect: 0, got: (v) => v.result },
  { id: 'sum-of-all-subsets-xor-total', input: { nums: [5, 1, 6] }, expect: 28, got: (v) => v.result },
  { id: 'sum-of-all-subsets-xor-total', input: { nums: [1, 3] }, expect: 6, got: (v) => v.result },
  { id: 'sum-of-all-subsets-xor-total', input: { nums: [3, 4, 5, 6, 7, 8] }, expect: 480, got: (v) => v.result },
  { id: 'permutations', input: { nums: [1, 2, 3] }, expect: 6, got: (v) => v.result },
  { id: 'permutations', input: { nums: [1, 2] }, expect: '[1,2] [2,1]', got: (v) => (v.res as string[]).join(' ') },
  { id: 'permutations', input: { nums: [5] }, expect: 1, got: (v) => v.result },
  { id: 'permutations', input: { nums: [1, 2, 3, 4] }, expect: 24, got: (v) => v.result },
  { id: 'permutations-ii', input: { nums: [1, 1, 2] }, expect: 3, got: (v) => v.result },
  { id: 'permutations-ii', input: { nums: [1, 1, 2] }, expect: '[1,1,2] [1,2,1] [2,1,1]', got: (v) => (v.res as string[]).join(' ') },
  { id: 'permutations-ii', input: { nums: [1, 2, 3] }, expect: 6, got: (v) => v.result },
  { id: 'permutations-ii', input: { nums: [2, 2, 2, 2] }, expect: 1, got: (v) => v.result },
  { id: 'generate-parentheses', input: { n: 3 }, expect: 5, got: (v) => v.result },
  { id: 'generate-parentheses', input: { n: 1 }, expect: '()', got: (v) => (v.res as string[]).join(' ') },
  { id: 'generate-parentheses', input: { n: 2 }, expect: '(()) ()()', got: (v) => (v.res as string[]).join(' ') },
  { id: 'generate-parentheses', input: { n: 4 }, expect: 14, got: (v) => v.result },
  { id: 'letter-combinations-of-a-phone-number', input: { digits: '23' }, expect: 9, got: (v) => v.result },
  { id: 'letter-combinations-of-a-phone-number', input: { digits: '' }, expect: 0, got: (v) => v.result },
  { id: 'letter-combinations-of-a-phone-number', input: { digits: '2' }, expect: 'a b c', got: (v) => (v.res as string[]).join(' ') },
  { id: 'letter-combinations-of-a-phone-number', input: { digits: '79' }, expect: 16, got: (v) => v.result },
  { id: 'palindrome-partitioning', input: { s: 'aab' }, expect: 2, got: (v) => v.result },
  { id: 'palindrome-partitioning', input: { s: 'aab' }, expect: '[a|a|b] [aa|b]', got: (v) => (v.res as string[]).join(' ') },
  { id: 'palindrome-partitioning', input: { s: 'a' }, expect: 1, got: (v) => v.result },
  { id: 'palindrome-partitioning', input: { s: 'abc' }, expect: 1, got: (v) => v.result },
  { id: 'palindrome-partitioning', input: { s: 'aaa' }, expect: 4, got: (v) => v.result },
  { id: 'word-break-ii', input: { s: 'catsanddog', dict: ['cat', 'cats', 'and', 'sand', 'dog'] }, expect: 2, got: (v) => v.result },
  { id: 'word-break-ii', input: { s: 'catsandog', dict: ['cats', 'dog', 'sand', 'and', 'cat'] }, expect: 0, got: (v) => v.result },
  { id: 'word-break-ii', input: { s: 'aaa', dict: ['a', 'aa'] }, expect: 3, got: (v) => v.result },
  { id: 'word-break-ii', input: { s: 'aaa', dict: ['a', 'aa'] }, expect: '"a a a", "a aa", "aa a"', got: (v) => (v.res as string[]).map((r) => `"${r}"`).join(', ') },
  { id: 'matchsticks-to-square', input: { sticks: [1, 1, 2, 2, 2] }, expect: true, got: (v) => v.result },
  { id: 'matchsticks-to-square', input: { sticks: [3, 3, 3, 3, 4] }, expect: false, got: (v) => v.result },
  { id: 'matchsticks-to-square', input: { sticks: [5, 5, 5, 5] }, expect: true, got: (v) => v.result },
  { id: 'matchsticks-to-square', input: { sticks: [1, 1, 1, 1, 1] }, expect: false, got: (v) => v.result },
  { id: 'matchsticks-to-square', input: { sticks: [8, 1, 1, 1, 1] }, expect: false, got: (v) => v.result },
  { id: 'partition-to-k-equal-sum-subsets', input: { nums: [4, 3, 2, 3, 5, 2, 1], k: 4 }, expect: true, got: (v) => v.result },
  { id: 'partition-to-k-equal-sum-subsets', input: { nums: [2, 2, 2, 2, 3, 4, 5], k: 4 }, expect: false, got: (v) => v.result },
  { id: 'partition-to-k-equal-sum-subsets', input: { nums: [4, 4, 4, 4], k: 4 }, expect: true, got: (v) => v.result },
  { id: 'partition-to-k-equal-sum-subsets', input: { nums: [1, 2, 3, 4], k: 3 }, expect: false, got: (v) => v.result },
  { id: 'partition-to-k-equal-sum-subsets', input: { nums: [1, 2, 3], k: 1 }, expect: true, got: (v) => v.result },
  { id: 'n-queens', input: { n: 4 }, expect: 2, got: (v) => v.result },
  { id: 'n-queens', input: { n: 1 }, expect: 1, got: (v) => v.result },
  { id: 'n-queens', input: { n: 2 }, expect: 0, got: (v) => v.result },
  { id: 'n-queens', input: { n: 3 }, expect: 0, got: (v) => v.result },
  { id: 'n-queens', input: { n: 5 }, expect: 10, got: (v) => v.result },
  { id: 'n-queens', input: { n: 4 }, expect: '.Q../...Q/Q.../..Q. ..Q./Q.../...Q/.Q..', got: (v) => (v.res as string[]).join(' ') },
  { id: 'n-queens-ii', input: { n: 4 }, expect: 2, got: (v) => v.result },
  { id: 'n-queens-ii', input: { n: 1 }, expect: 1, got: (v) => v.result },
  { id: 'n-queens-ii', input: { n: 3 }, expect: 0, got: (v) => v.result },
  { id: 'n-queens-ii', input: { n: 6 }, expect: 4, got: (v) => v.result },
  ...
  // Two Pointers (NeetCode 250 additions)
  { id: 'reverse-string', input: { s: 'hello' }, expect: 'olleh', got: (v) => v.result },
  { id: 'reverse-string', input: { s: 'ab' }, expect: 'ba', got: (v) => v.result },
  { id: 'reverse-string', input: { s: 'x' }, expect: 'x', got: (v) => v.result },
  { id: 'valid-palindrome-ii', input: { s: 'abca' }, expect: true, got: (v) => v.result },
  { id: 'valid-palindrome-ii', input: { s: 'abc' }, expect: false, got: (v) => v.result },
  { id: 'valid-palindrome-ii', input: { s: 'aba' }, expect: true, got: (v) => v.result },
  { id: 'valid-palindrome-ii', input: { s: 'deeee' }, expect: true, got: (v) => v.result },
  { id: 'merge-strings-alternately', input: { word1: 'abc', word2: 'pqrs' }, expect: 'apbqcrs', got: (v) => v.result },
  { id: 'merge-strings-alternately', input: { word1: 'ab', word2: 'pqrs' }, expect: 'apbqrs', got: (v) => v.result },
  { id: 'merge-strings-alternately', input: { word1: 'abcd', word2: 'pq' }, expect: 'apbqcd', got: (v) => v.result },
  { id: 'merge-sorted-array', input: { nums1: [1, 2, 3], nums2: [2, 5, 6] }, expect: '1,2,2,3,5,6', got: (v) => v.result },
  { id: 'merge-sorted-array', input: { nums1: [], nums2: [1] }, expect: '1', got: (v) => v.result },
  { id: 'merge-sorted-array', input: { nums1: [4, 5, 6], nums2: [1, 2, 3] }, expect: '1,2,3,4,5,6', got: (v) => v.result },
  { id: 'remove-duplicates-sorted', input: { nums: [0, 0, 1, 1, 1, 2, 2, 3, 3, 4] }, expect: 5, got: (v) => v.result },
  { id: 'remove-duplicates-sorted', input: { nums: [1, 1, 2] }, expect: 2, got: (v) => v.result },
  { id: 'remove-duplicates-sorted', input: { nums: [7] }, expect: 1, got: (v) => v.result },
  { id: 'two-sum-ii', input: { numbers: [2, 7, 11, 15], target: 9 }, expect: '1,2', got: (v) => (v.result as number[]).join(',') },
  { id: 'two-sum-ii', input: { numbers: [2, 3, 4], target: 6 }, expect: '1,3', got: (v) => (v.result as number[]).join(',') },
  { id: 'two-sum-ii', input: { numbers: [1, 2], target: 99 }, expect: '', got: (v) => (v.result as number[]).join(',') },
  { id: 'four-sum', input: { nums: [1, 0, -1, 0, -2, 2], target: 0 }, expect: '(-2, -1, 1, 2) (-2, 0, 0, 2) (-1, 0, 0, 1)', got: (v) => (v.res as string[]).join(' ') },
  { id: 'four-sum', input: { nums: [2, 2, 2, 2, 2], target: 8 }, expect: '(2, 2, 2, 2)', got: (v) => (v.res as string[]).join(' ') },
  { id: 'four-sum', input: { nums: [1, 2, 3, 4], target: 99 }, expect: '', got: (v) => (v.res as string[]).join(' ') },
  { id: 'rotate-array', input: { nums: [1, 2, 3, 4, 5, 6, 7], k: 3 }, expect: '5,6,7,1,2,3,4', got: (v) => v.result },
  { id: 'rotate-array', input: { nums: [1, 2], k: 3 }, expect: '2,1', got: (v) => v.result },
  { id: 'rotate-array', input: { nums: [1, 2, 3], k: 0 }, expect: '1,2,3', got: (v) => v.result },
  { id: 'boats-to-save-people', input: { people: [3, 2, 2, 1], limit: 3 }, expect: 3, got: (v) => v.result },
  { id: 'boats-to-save-people', input: { people: [1, 2], limit: 3 }, expect: 1, got: (v) => v.result },
  { id: 'boats-to-save-people', input: { people: [3, 5, 3, 4], limit: 5 }, expect: 4, got: (v) => v.result },
  { id: 'trapping-rain-water', input: { height: [0, 1, 0, 2, 1, 0, 1, 3, 2, 1, 2, 1] }, expect: 6, got: (v) => v.result },
  { id: 'trapping-rain-water', input: { height: [4, 2, 0, 3, 2, 5] }, expect: 9, got: (v) => v.result },
  { id: 'trapping-rain-water', input: { height: [1, 2, 3] }, expect: 0, got: (v) => v.result },
  // Sliding Window
  { id: 'contains-duplicate-ii', input: { nums: [1, 2, 3, 1], k: 3 }, expect: true, got: (v) => v.result },
  { id: 'contains-duplicate-ii', input: { nums: [1, 2, 3, 1, 2, 3], k: 2 }, expect: false, got: (v) => v.result },
  { id: 'contains-duplicate-ii', input: { nums: [1, 0, 1, 1], k: 1 }, expect: true, got: (v) => v.result },
  { id: 'permutation-in-string', input: { s1: 'ab', s2: 'eidbaooo' }, expect: true, got: (v) => v.result },
  { id: 'permutation-in-string', input: { s1: 'ab', s2: 'eidboaoo' }, expect: false, got: (v) => v.result },
  { id: 'permutation-in-string', input: { s1: 'abc', s2: 'ab' }, expect: false, got: (v) => v.result },
  { id: 'minimum-size-subarray-sum', input: { target: 7, nums: [2, 3, 1, 2, 4, 3] }, expect: 2, got: (v) => v.result },
  { id: 'minimum-size-subarray-sum', input: { target: 11, nums: [1, 1, 1, 1] }, expect: 0, got: (v) => v.result },
  { id: 'minimum-size-subarray-sum', input: { target: 4, nums: [1, 4, 4] }, expect: 1, got: (v) => v.result },
  { id: 'find-k-closest-elements', input: { arr: [1, 2, 3, 4, 5], k: 4, x: 3 }, expect: '1,2,3,4', got: (v) => v.result },
  { id: 'find-k-closest-elements', input: { arr: [1, 2, 3, 4, 5], k: 4, x: -1 }, expect: '1,2,3,4', got: (v) => v.result },
  { id: 'find-k-closest-elements', input: { arr: [1, 5, 9], k: 1, x: 8 }, expect: '9', got: (v) => v.result },
  { id: 'sliding-window-maximum', input: { nums: [1, 3, -1, -3, 5, 3, 6, 7], k: 3 }, expect: '3,3,5,5,6,7', got: (v) => v.result },
  { id: 'sliding-window-maximum', input: { nums: [1], k: 1 }, expect: '1', got: (v) => v.result },
  { id: 'sliding-window-maximum', input: { nums: [7, 2, 4], k: 2 }, expect: '7,4', got: (v) => v.result },
  // Bit Manipulation
  { id: 'single-number', input: { nums: [4, 1, 2, 1, 2] }, expect: 4, got: (v) => v.result },
  { id: 'single-number', input: { nums: [1] }, expect: 1, got: (v) => v.result },
  { id: 'single-number', input: { nums: [2, 2, 1] }, expect: 1, got: (v) => v.result },
  { id: 'add-binary', input: { a: '1010', b: '1011' }, expect: '10101', got: (v) => v.result },
  { id: 'add-binary', input: { a: '11', b: '1' }, expect: '100', got: (v) => v.result },
  { id: 'add-binary', input: { a: '0', b: '0' }, expect: '0', got: (v) => v.result },
  { id: 'reverse-integer', input: { x: 123 }, expect: 321, got: (v) => v.result },
  { id: 'reverse-integer', input: { x: -123 }, expect: -321, got: (v) => v.result },
  { id: 'reverse-integer', input: { x: 120 }, expect: 21, got: (v) => v.result },
  { id: 'reverse-integer', input: { x: 1534236469 }, expect: 0, got: (v) => v.result },
  { id: 'bitwise-and-of-range', input: { left: 5, right: 7 }, expect: 4, got: (v) => v.result },
  { id: 'bitwise-and-of-range', input: { left: 0, right: 0 }, expect: 0, got: (v) => v.result },
  { id: 'bitwise-and-of-range', input: { left: 1, right: 2147483647 % 65536 }, expect: 0, got: (v) => v.result },
  { id: 'minimum-array-end', input: { n: 3, x: 4 }, expect: 6, got: (v) => v.result },
  { id: 'minimum-array-end', input: { n: 2, x: 7 }, expect: 15, got: (v) => v.result },
  { id: 'minimum-array-end', input: { n: 1, x: 9 }, expect: 9, got: (v) => v.result },
  // 1-D Dynamic Programming
  { id: 'min-cost-climbing-stairs', input: { cost: [1, 100, 1, 1, 1, 100, 1, 1, 100, 1] }, expect: 6, got: (v) => v.result },
  { id: 'min-cost-climbing-stairs', input: { cost: [10, 15, 20] }, expect: 15, got: (v) => v.result },
  { id: 'tribonacci', input: { n: 10 }, expect: 149, got: (v) => v.result },
  { id: 'tribonacci', input: { n: 4 }, expect: 4, got: (v) => v.result },
  { id: 'tribonacci', input: { n: 0 }, expect: 0, got: (v) => v.result },
  { id: 'partition-equal-subset-sum', input: { nums: [1, 5, 11, 5] }, expect: true, got: (v) => v.result },
  { id: 'partition-equal-subset-sum', input: { nums: [1, 2, 3, 5] }, expect: false, got: (v) => v.result },
  { id: 'partition-equal-subset-sum', input: { nums: [2, 2] }, expect: true, got: (v) => v.result },
  { id: 'combination-sum-iv', input: { nums: [1, 2, 3], target: 4 }, expect: 7, got: (v) => v.result },
  { id: 'combination-sum-iv', input: { nums: [9], target: 3 }, expect: 0, got: (v) => v.result },
  { id: 'combination-sum-iv', input: { nums: [2], target: 4 }, expect: 1, got: (v) => v.result },
  { id: 'perfect-squares', input: { n: 12 }, expect: 3, got: (v) => v.result },
  { id: 'perfect-squares', input: { n: 13 }, expect: 2, got: (v) => v.result },
  { id: 'perfect-squares', input: { n: 1 }, expect: 1, got: (v) => v.result },
  { id: 'integer-break', input: { n: 10 }, expect: 36, got: (v) => v.result },
  { id: 'integer-break', input: { n: 2 }, expect: 1, got: (v) => v.result },
  { id: 'integer-break', input: { n: 8 }, expect: 18, got: (v) => v.result },
  { id: 'stone-game-iii', input: { stones: [1, 2, 3, 7] }, expect: 'Bob', got: (v) => v.result },
  { id: 'stone-game-iii', input: { stones: [1, 2, 3, -9] }, expect: 'Alice', got: (v) => v.result },
  { id: 'stone-game-iii', input: { stones: [1, 2, 3, 6] }, expect: 'Tie', got: (v) => v.result },
  // Greedy
  { id: 'lemonade-change', input: { bills: [5, 5, 5, 10, 20] }, expect: true, got: (v) => v.result },
  { id: 'lemonade-change', input: { bills: [5, 5, 10, 10, 20] }, expect: false, got: (v) => v.result },
  { id: 'lemonade-change', input: { bills: [10] }, expect: false, got: (v) => v.result },
  { id: 'max-sum-circular-subarray', input: { nums: [5, -3, 5] }, expect: 10, got: (v) => v.result },
  { id: 'max-sum-circular-subarray', input: { nums: [1, -2, 3, -2] }, expect: 3, got: (v) => v.result },
  { id: 'max-sum-circular-subarray', input: { nums: [-3, -2, -3] }, expect: -2, got: (v) => v.result },
  { id: 'longest-turbulent-subarray', input: { arr: [9, 4, 2, 10, 7, 8, 8, 1, 9] }, expect: 5, got: (v) => v.result },
  { id: 'longest-turbulent-subarray', input: { arr: [4, 8, 12, 16] }, expect: 2, got: (v) => v.result },
  { id: 'longest-turbulent-subarray', input: { arr: [100] }, expect: 1, got: (v) => v.result },
  { id: 'jump-game-ii', input: { nums: [2, 3, 1, 1, 4] }, expect: 2, got: (v) => v.result },
  { id: 'jump-game-ii', input: { nums: [2, 3, 0, 1, 4] }, expect: 2, got: (v) => v.result },
  { id: 'jump-game-ii', input: { nums: [0] }, expect: 0, got: (v) => v.result },
  { id: 'jump-game-vii', input: { s: '011010', minJump: 2, maxJump: 3 }, expect: true, got: (v) => v.result },
  { id: 'jump-game-vii', input: { s: '01101110', minJump: 2, maxJump: 3 }, expect: false, got: (v) => v.result },
  { id: 'gas-station', input: { gas: [1, 2, 3, 4, 5], cost: [3, 4, 5, 1, 2] }, expect: 3, got: (v) => v.result },
  { id: 'gas-station', input: { gas: [2, 3, 4], cost: [3, 4, 3] }, expect: -1, got: (v) => v.result },
  { id: 'gas-station', input: { gas: [5], cost: [4] }, expect: 0, got: (v) => v.result },
  { id: 'hand-of-straights', input: { hand: [1, 2, 3, 6, 2, 3, 4, 7, 8], groupSize: 3 }, expect: true, got: (v) => v.result },
  { id: 'hand-of-straights', input: { hand: [1, 2, 3, 4, 5], groupSize: 4 }, expect: false, got: (v) => v.result },
  { id: 'hand-of-straights', input: { hand: [1, 1, 2, 2, 3, 3], groupSize: 3 }, expect: true, got: (v) => v.result },
  { id: 'dota2-senate', input: { senate: 'RD' }, expect: 'Radiant', got: (v) => v.result },
  { id: 'dota2-senate', input: { senate: 'RDD' }, expect: 'Dire', got: (v) => v.result },
  { id: 'dota2-senate', input: { senate: 'DDRRR' }, expect: 'Dire', got: (v) => v.result },
  { id: 'merge-triplets', input: { triplets: '2,5,3; 1,8,4; 1,7,5', target: '2,7,5' }, expect: true, got: (v) => v.result },
  { id: 'merge-triplets', input: { triplets: '3,4,5; 4,5,6', target: '3,2,5' }, expect: false, got: (v) => v.result },
  { id: 'partition-labels', input: { s: 'ababcbacadefegde' }, expect: '9,7', got: (v) => v.result },
  { id: 'partition-labels', input: { s: 'eccbbbbdec' }, expect: '10', got: (v) => v.result },
  { id: 'partition-labels', input: { s: 'abc' }, expect: '1,1,1', got: (v) => v.result },
  { id: 'valid-parenthesis-string', input: { s: '(*))' }, expect: true, got: (v) => v.result },
  { id: 'valid-parenthesis-string', input: { s: '(((' }, expect: false, got: (v) => v.result },
  { id: 'valid-parenthesis-string', input: { s: ')(' }, expect: false, got: (v) => v.result },
  { id: 'valid-parenthesis-string', input: { s: '(*)' }, expect: true, got: (v) => v.result },
  { id: 'candy', input: { ratings: [1, 0, 2] }, expect: 5, got: (v) => v.result },
  { id: 'candy', input: { ratings: [1, 2, 2] }, expect: 4, got: (v) => v.result },
  { id: 'candy', input: { ratings: [1, 3, 2, 2, 1] }, expect: 7, got: (v) => v.result },
];
